...
<!-- sources: docs.pencil.dev (2026-03-10), Pencil Sensei agent (2026-03-21/22) -->
...
| Type | Structure |
|------|-----------|
| **Text responses** | `{content: [{type: "text", text: "JSON string"}]}` |
| **Screenshots** | `{content: [{type: "image", data: "base64..."}]}` |
| **Errors** | Check `isError: true` in response |
